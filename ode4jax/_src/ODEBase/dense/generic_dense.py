...
def addsteps(
    k, t, uprev, u, dt, f, p, cache, always_calc_begin, allow_calc_end, force_calc_end
):
    if length(k) < 2:
...
def hermite_interpolant(
    Θ, dt, y0, y1, k, cache, idxs: None, deriv
):  # Default interpolant is Hermite
    """
