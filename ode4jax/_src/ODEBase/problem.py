...
from ode4jax.base import AbstractProblem, wrap_function
from pytreearray import PyTreeArray1
...
class ODEProblem(AbstractProblem):
    ...
    def __pre_init__(self, fun, tspan, u0, *, p=(), **kwargs):
        if len(tspan) != 2:
        ...
        _fun = wrap_function(fun, **kwargs)

        return (_fun, tspan, u0, p), {}
