...
def matmul(pt1, pt2):
    ...
    if pt1.treedef_r != pt2.treedef_l:
        raise ValueError(f"Mismatch of pytrees: \n  {pt1.treedef_r}\n  {pt2.treedef_l}")
    if pt1.axes_r != pt2.axes_l:
        raise ValueError(f"Mismatch of axes: \n  {pt1.axes_r}\n  {pt2.axes_l}")
    ...
    if pt1_1d and pt2_1d:
        ...
        return core.PyTreeArray(
            tree, pt1.treedefs[:-1] + pt2.treedefs[1:], pt1.axes[:-1] + pt2.axes[1:]
        )
